...
/**
 * EventListener that reacts even when the service worke will be installed
 */
...
/**
 * EventListener that reacts even when the service worke will be activated
 */
...
/**
 * EventListener that reacts even when data should be loaded from server
 */
