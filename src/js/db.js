var idb = function (e) {
    ...
    let n, r;
    const o = new WeakMap, s = new WeakMap, a = new WeakMap, i = new WeakMap, c = new WeakMap;
    let u = {
        get(e, t, n) {
    ...
    function f(e) {
        return e !== IDBDatabase.prototype.transaction || "objectStoreNames" in IDBTransaction.prototype ? (r || (r = [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey])).includes(e) ? function (...t) {
            return e.apply(D(this), t), p(o.get(this))
        } : function (...t) {
            return p(e.apply(D(this), t))
        } : function (t, ...n) {
    ...
    const D = e => c.get(e);
    const I = ["get", "getKey", "getAll", "getAllKeys", "count"], B = ["put", "add", "delete", "clear"], b = new Map;

    function v(e, t) {
        if (!(e instanceof IDBDatabase) || t in e || "string" != typeof t) return;
        if (b.get(t)) return b.get(t);
        const n = t.replace(/FromIndex$/, ""), r = t !== n, o = B.includes(n);
    ...
    d((e => ({...e, get: (t, n, r) => v(t, n) || e.get(t, n, r), has: (t, n) => !!v(t, n) || e.has(t, n)})));
    const g = ["continue", "continuePrimaryKey", "advance"], y = {}, h = new WeakMap, m = new WeakMap, w = {
        get(e, t) {
            if (!g.includes(t)) return e[t];
            let n = y[t];
            return n || (n = y[t] = function (...e) {
                h.set(this, m.get(this)[t](...e))
            }), n
        }
    };
    ...
    async function* E(...e) {
        ...
        t = t;
        const n = new Proxy(t, w);
        for (m.set(n, t), c.set(n, D(t)); t;) yield n, t = await (h.get(n) || t.continue()), h.delete(n)
    }
